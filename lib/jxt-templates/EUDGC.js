export default {
  "dgc.test:1": {
    "columns": [
      ...
      {"path": "proof.verificationMethod", "encoder": "did"}
    ],
    "template": {
      "@context": [
  ...
  "dgc.recv:1": {
    "columns": [
      ...
      {"path": "credentialSubject.id", "encoder": "urn:uvci"},
      {"path": "credentialSubject.issuerName", "encoder": "string"},
      {"path": "credentialSubject.validFrom", "encoder": "isodate-1900-base32"},
      {"path": "credentialSubject.validUntil", "encoder": "isodate-1900-base32"},
